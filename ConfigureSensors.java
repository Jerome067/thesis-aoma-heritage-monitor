...
public class ConfigureSensors extends JFrame {
    ...
    private final Color fieldColor = new Color(220, 220, 220);
    ...
    public ConfigureSensors() {
        ...
        editProfileBtn.setBounds(sidebarWidth - 50, 0, 40, 25);
        ...
        // code for the ellipsis button at the bottom of ESP panel
